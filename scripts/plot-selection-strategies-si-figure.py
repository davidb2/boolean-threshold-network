...
STYLES = {
  ...
  'anchor-reporter':    {'color': '#9467bd', 'label': 'reserve quiet nodes, then information gain', 'lw': 2.2, 'ls': '--', 'zorder': 11},
  ...
  'anchor-sensitivity': {'color': '#8c6bb1', 'label': 'reserve least sensitive nodes', 'lw': 1.8, 'ls': '--', 'zorder': 8},
